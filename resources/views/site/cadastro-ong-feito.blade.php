...
<html lang="pt-br">
            ...
            <div class="offcanvas offcanvas-end" tabhome="-1" id="offcanvasLightNavbar" aria-labelledby="offcanvasLightNavbarLabel">
                ...
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Meu Perfil</a>
  ...
  <form id="msform-post-certo">
    <fieldset class="sucesso" align-items: center>
        ...
        <br><br><br> <br>
        <h3 class="main-title-post-certo"> Cadastro feito com sucesso!</h3>
        <br>
        <a href="{{route('site.login')}}" class="submit action-button" target="_top">OK</a>
        <br><br><br>
    </fieldset>
  </form>
